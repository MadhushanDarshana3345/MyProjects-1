...
export default function Register() {
  ...
  const handleRegister = () => {
    ...
    if ((!values.email) && (!values.password)) {
      ...
      Axios.post("http://localhost:3001/api/Driverregister", { name:values.name, address:values.address,phone:values.phone, password: values.password, email: values.email }).then((response) => {
